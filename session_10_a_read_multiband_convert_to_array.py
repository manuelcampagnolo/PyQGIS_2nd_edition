...
fn_new=os.path.join(myfolder,'temp','new_raster.tif')
ln='S2SR-B2348'
...
# create empty raster with gdal using parameters above
my_new_raster=None
...
# load new raster
my_rlayer=iface.addRasterLayer(fn_new)

# what is the no data value for the new raster
my_rlayer.dataProvider().sourceNoDataValue(1)

create_raster_ramp_legend(lyr=my_rlayer,dict=my_dict, type='Discrete')
