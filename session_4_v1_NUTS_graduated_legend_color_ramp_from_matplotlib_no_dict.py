# session 4_v1 graduated legend for NUTS using area and matplotlib colormap
# the code creates directly the symbology 
# it does not create a dictionary to hold the classes
...
# Define legend to use
# Creates list of categories (one for each legend class)
myRangeList=[]
count=0
